...
class CreditmemoObserverTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function creditOrder()
    {
        ...
        $creditmemoFactory = $this->objectManager->get('\Magento\Sales\Model\Order\CreditmemoFactory');
        ...
        $creditmemoRepository = $this->objectManager->get('\Magento\Sales\Api\CreditmemoRepositoryInterface');
